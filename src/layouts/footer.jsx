    ...
    return (
        ...
        >
            <div className="flex flex-col gap-[16px] border-b border-[#1D2E27] md:flex-row">
                    ...
                    <div className="flex flex-col gap-[16px]">
                        <div className="flex items-center gap-[10px]">
                            <img
                                ...
                                alt="social"
                                className="h-[20px] w-[20px] md:h-[46px] md:w-[46px]"
                            />
                            <div className="text-[14px] font-bold md:text-[29px]">
                                Social
                            </div>
                        </div>
                ...
                <div className="flex-1 py-[20px] text-[10px] md:text-[14px]">
            ...
            <div className="py-[20px] text-[10px] md:text-[14px]">
